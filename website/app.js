...
const APIkey = '&appid=cd9bd3a48f49dc38bf229b3fabfe84a3&units=metric';
...
async function UpdateUI(){
    ...
    try{
        ...
        document.getElementById('temp').innerHTML = `The Temprature is ${Data.temp}°`;
        document.getElementById('content').innerHTML = `And I feel ${Data.content}`;
    }catch(error){
        console.log('error' + error);
    }
}
